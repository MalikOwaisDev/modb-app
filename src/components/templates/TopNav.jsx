...
const TopNav = () => {
  ...
  return (
    <div className="relative z-[1000]">
      <div
        className="w-full backdrop-blur-md bg-zinc-900/40 border-b border-zinc-800/30 sticky top-0 z-50"
        style={{
      ...
      {showResults && (
        <div
          ...
          className={`absolute top-[100%] ${
            !isMobile && "left-[10%]"
          } w-full bg-zinc-900/95 backdrop-blur-md rounded-b-2xl shadow-2xl z-[9999] border border-zinc-700/30 ${
            isMobile ? "" : "mx-auto max-w-2xl"
          }`}
          style={{
            boxShadow:
